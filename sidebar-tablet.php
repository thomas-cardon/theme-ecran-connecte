<aside data-active="1" class="sidebar-tablet">
      <a href="<?php echo home_url('/tablet-view'); ?>">
        <div class="brand">
          <img width="40px" height="40px" src="https://via.placeholder.com/150" />
          <h3>Mode Tablette</h3>
        </div>
      </a>
      <div class="list list-dark">
        <a href="<?php echo home_url('tablet-view'); ?>" class="item">
          <div class="icon">
            <svg width="24" height="24" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="transform transition-transform duration-500 ease-in-out" data-darkreader-inline-stroke="" style="--darkreader-inline-stroke:currentColor;"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 14v6m-3-3h6M6 10h2a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v2a2 2 0 002 2zm10 0h2a2 2 0 002-2V6a2 2 0 00-2-2h-2a2 2 0 00-2 2v2a2 2 0 002 2zM6 20h2a2 2 0 002-2v-2a2 2 0 00-2-2H6a2 2 0 00-2 2v2a2 2 0 002 2z"></path></svg>
          </div>
          Tableau de bord
        </a>

        <a href="<?php echo home_url('/tablet-view/emploi-du-temps'); ?>" class="item">
          <div class="icon">
